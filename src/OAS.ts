 ...
 * - Some union and mutual exclusion types are omitted.
 *
 * Therefore it's worth noting that an object conforming to this interface is **not
 ...
 * @see {@link https://swagger.io/specification/v3/#:~:text=Schema,-This}
 */
